...
struct Usuarios {
	//Usuarios();		//Constructor por defecto
...
// Lista de tweets
struct FechaHora {
    //FechaHora();	//Constructor por defecto
    unsigned anyo, mes, dia,
    		 hora, minuto, segundo;
};
/*
//Definicion del constructor por defecto FechaHora()
FechaHora::FechaHora() {
	anyo = 0; mes = 0; dia = 0;
...
struct Tweet {
	//Tweet();	//Constructor por defecto
    std::string tweet;
    FechaHora fecha_hora;
};
/*
//Definicion del constructor por defecto Tweet()
Tweet::Tweet() {
	tweet = "";
	FechaHora(fecha_hora);
}
...
struct Tweets {
	//Tweets();	//Constructor por defecto
    unsigned num_tweets;
    ListaTweets listado;
};
/*
//Definicion del constructor por defecto Tweets()
Tweets::Tweets() {
	num_tweets = 0;
